  ...
  const Chatbot = () => {
    ...
    return (
      <div className="fixed bottom-5 right-5 z-50">
        ...
        {isOpen && (
          <div className="absolute bottom-16 right-0 w-80 rounded-lg bg-white shadow-xl border border-gray-200">
            ...
            <div className="p-4">
              <button
                onClick={expandChat}
                className="flex items-center gap-2 w-full rounded-lg bg-blue-600 text-white px-4 py-2 hover:bg-blue-700 transition-colors"
              >
